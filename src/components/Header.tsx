  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        {/* Top Bar */}
        <div
          className={`py-2 text-center text-sm border-b ${
            isDarkMode
              ? 'border-gray-800 bg-gradient-to-r from-teal-900/20 to-green-900/20'
              : 'border-gray-100 bg-gradient-to-r from-teal-50/50 to-green-50/50'
          }`}
        >
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center space-x-4 cursor-pointer group">
            <div className="relative w-28 h-12 transition-transform duration-300 group-hover:scale-105">
              <img src="/images/logo.png" alt="INFINIPETS Logo" className="w-full h-full object-contain" />
            </div>
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            {[
              ...
              <div key={item.name} className="relative group">
                ...
                {item.hasDropdown && (
                  <div
                    className={`absolute top-full left-0 mt-2 w-72 rounded-xl shadow-2xl border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 ${
                      isDarkMode
          ...
          <div className="flex items-center space-x-2" ref={searchRef}>
            ...
            <div className="relative">
              ...
              {isSearchOpen && (
                <div
                  className={`absolute right-0 top-full mt-2 w-80 rounded-full shadow-2xl border p-4 animate-in slide-in-from-top-2 duration-300 ${
                    isDarkMode ? 'bg-gray-800/95 border-gray-700 backdrop-blur-xl' : 'bg-white/95 border-gray-200 backdrop-blur-xl'
                  }`}
                >
                  <input
                    type="text"
                  ...
                  {suggestions.length > 0 && (
                    <ul
                      className={`mt-2 max-h-48 overflow-auto rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg ${
            ...
            {/* Notifications */}
            <button
              className={`relative p-3 rounded-lg transition-all duration-300 hover:bg-teal-500/10 ${
                isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'
              }`}
        ...
        {isMenuOpen && (
          <div
            className={`lg:hidden border-t py-4 animate-in slide-in-from-top-4 duration-300 ${
